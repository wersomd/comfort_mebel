      ...
      <section className="border-t border-[#E8D9C6]">
        <div className="max-w-[1440px] mx-auto px-6 lg:px-12 py-14">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { title: 'Премиум материалы', desc: 'Только высококачественные ткани, дерево и металл от проверенных поставщиков.' },
              { title: 'Гарантия 3 года',   desc: 'Каждое изделие проходит контроль качества и поставляется с гарантией.' },
              { title: 'Доставка по Казахстану', desc: 'Бесплатная доставка и профессиональная сборка по всей стране.' },
            ].map((f, i) => (
